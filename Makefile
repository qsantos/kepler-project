...
example: dict.o vector.o coordinates.o body.o orbit.o recipes.o load.o lambert.o
test: dict.o vector.o coordinates.o body.o orbit.o load.o recipes.o lambert.o
